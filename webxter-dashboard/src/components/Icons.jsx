...
export function IconPlay({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" /><polygon fill={color} stroke="none" points="10,8 16,12 10,16" />
    </svg>
  );
}
...
export function IconPause({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="6" y="4" width="4" height="16" fill={color} stroke="none" /><rect x="14" y="4" width="4" height="16" fill={color} stroke="none" />
    </svg>
  );
}

export function IconVideo({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function IconInfo({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function IconGoogleMeet({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <rect width="24" height="24" rx="6" fill="#00897B"/>
      <path d="M14.5 12l3.5-2.5V14.5L14.5 12z" fill="#fff"/>
      <rect x="6" y="8" width="8" height="8" rx="1.5" fill="#fff"/>
    </svg>
  );
}
...
export function IconZoom({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M13.5 9.5H7a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h6.5a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1z" fill="#fff"/>
      <path d="M15.5 11.2l2.5-1.7v5l-2.5-1.7v-1.6z" fill="#fff"/>
    </svg>
  );
}
